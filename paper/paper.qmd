...
![Average FASTA formatted data size (bytes) following Bzip2, Xz, Zlib, default Zstd and dictionary-based Zstd compression. *Escherichia coli* MS 200-1 (NZ_ADUC00000000) artifact for Zstd dictionary generation. Randomized DNA sequences within the range of 100 000 to 150 000 base pairs.](/var/home/mpersico/distrobox/ubuntu-zstd/Persico2022/assets/plots/Compression_Performance_Boxplot.png){#fig-performance}
