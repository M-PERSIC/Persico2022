---
title: "Proof of concept Zstandard custom compression dictionary for FASTA files"
format:
  plos-pdf:
...
I would like to express my sincere gratitude to Professor David Walsh for his advice that helped shape the research as it progressed; My friends and family that supported me throughout my studies; The Julia community for their support before and throughout the writing of this paper; The Quarto developers for producing the Quarto publishing system along with the PLOS template used in this paper; Luca Di Maio and contributors to the Distrobox tool for the ease of setting up the containerized development environments; Maximiliano Sandoval and contributors to the Citations app  for managing the paper's bibliography, and all other persons that had indirectly assisted through their programs and research.
